"""
Django settings for my_moovies_eduardo_remi_4 project.
...
ROOT_URLCONF = 'my_moovies_eduardo_remi_4.urls'
...
WSGI_APPLICATION = 'my_moovies_eduardo_remi_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "my_moovies_eduardo_remi_4 API",
    "DESCRIPTION": "API documentation for my_moovies_eduardo_remi_4 App",
    "VERSION": "v1",
}
