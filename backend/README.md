...
## Project Structure
    ...
    ├── my_moovies_eduardo_remi_4  # Django project configurations
...
1. Clone this repo and `cd my_moovies_eduardo_remi_4`
...
2. Clone this repo and `cd my_moovies_eduardo_remi_4`
